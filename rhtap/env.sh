...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/ffp6ma4om-nodejs-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-xhrv9.xhrv9.sandbox757.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-xhrv9.xhrv9.sandbox757.opentlc.com}
